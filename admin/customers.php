          ...
          ?>
             <tr>
                ...
                <td>
                  <div class="row">
                      <div class="btn-group">
                        <a href="customer_edit.php?edit=<?php echo $row['id']; ?>" class="btn btn-success btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>
                        <a href="customer_delete.php?del=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm ms-1"><i class="fa-solid fa-trash"></i></a>
                      </div>
                  </div>
                </td>
            </tr>
