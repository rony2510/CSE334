    ...
    <div class="container-fluid">
      ...
      <?php include('include/sidebar.php'); ?>
        ...
        <nav aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="create-company.php" style="text-decoration: none;"> Company</a></li>
            <li class="breadcrumb-item active" aria-current="page"><a href="#" style="text-decoration: none;"> Add Company</a></li>
           </ol>
          </nav>
           ...
           <div id="msg"></div>
            <form method="POST" action="customer-add.php" style="margin:3%; padding:3%;">
                ...
                <div class="form-group mt-3">
                    <button type="submit" class="btn btn-block btn-success" name="company_save">Save</button>
                </div>
            </form>
        </div>
